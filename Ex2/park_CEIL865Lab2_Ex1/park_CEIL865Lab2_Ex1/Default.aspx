<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="park_CEIL865Lab2_Ex1.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Assginment2_1 - Sang Jun Park</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css"/>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
    <link href="Content/defaultView.css" rel="stylesheet" type="text/css" />
</head>
<body>
            ...
            <div class="row">
                <div class="Absolute-Center is-Responsive">
                    ...
                    <div class="form-group row" id="buttons">
                        <asp:Button ID="Clear" runat="server" Text="Clear form" OnClick="Clear_Click"/>
                        <asp:Button ID="Submit" runat="server" Text="Send us feedback" OnClick="Submit_Click"/>
                        <br />
